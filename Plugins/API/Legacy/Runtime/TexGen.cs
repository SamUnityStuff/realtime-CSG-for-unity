...
namespace RealtimeCSG.Legacy
{
    ...
    public struct TexGen
    {
        ...
        /// <param name="physicsMaterial">[UnityEngine.PhysicsMaterial](https://docs.unity3d.com/ScriptReference/PhysicsMaterial.html) to use with this <see cref="TexGen"/></param>
